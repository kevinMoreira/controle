...
//    $query =$query = 'SELECT * FROM categoria where idOrganizacao='. $_SESSION['idOrganizacao'] .' and status = 1 and
//     and status = 1 and idCategoria=(select idCategoria from produto where idProduto='.$_POST[codigo] .');';
...
function CarregarComboBoxProd(){
    ...
    /*$query = 'SELECT * FROM categoria where idOrganizacao='. $_SESSION['idOrganizacao'] .' and status = 1 and
     and status = 1 and idCategoria=(select idCategoria from produto where idProduto='.$_POST[codigo] .');';*/

//    $query = 'SELECT * FROM categoria where idOrganizacao='. $_SESSION['idOrganizacao'] .' and status = 1 and
//     and status = 1 and idCategoria='.$_POST[id_categoria] .';';
    $query = mysql_query($query, $conexao);
