...
function MontaMenu() {
    ...
    if ($_SESSION['permissao'] === '1') {
        ...
        $sql = "SELECT 
                ...
                WHERE 
                    c.idOrganizacao=".  $_SESSION['idOrganizacao'] ." and c.idUsuario=" . $_SESSION['codUsuario'] ." and m.status = 1";
    }
    ...
    while ($linha = mysql_fetch_row($Tb)) {
        ...
        $query="SELECT s.nome, s.link from sub_menu s
              ...
              WHERE s.idMenu=$linha[0] AND cs.idUsuario=$_SESSION[codUsuario] and idOrganizacao=". $_SESSION['idOrganizacao']." and s.status = 1";
